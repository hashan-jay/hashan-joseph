  ...
  return (
    ...
    >
      ...
      <div aria-hidden="true" className="pointer-events-none absolute inset-0 overflow-hidden">
        ...
        <div className="hero-grid absolute inset-[-48px] opacity-60" />
        <div className="starfield absolute inset-0" />
        <div className="starfield-dense absolute inset-0" />
        <span className="shooting-star" />
        <span className="shooting-star shooting-star-delay" />
...
→ scale(cluster, { replicas: 12 })`}
      ...
      <div className="section-pad relative mx-auto flex min-h-[100svh] max-w-6xl flex-col items-center justify-center pb-20 pt-28 text-center">
        <div className="animate-rise relative mb-8">
          ...
          <div className="relative h-28 w-28 overflow-hidden rounded-full border border-accent/40 sm:h-36 sm:w-36">
            <Image
        ...
        <div className="animate-rise inline-flex items-center gap-2 rounded-full border border-border bg-surface/60 px-4 py-1.5 backdrop-blur-sm">
          ...
          <span className="font-mono text-xs text-muted">{site.role}</span>
        </div>

        <h1 className="animate-rise-delay-1 mt-8 font-display text-[clamp(3.2rem,12vw,6.75rem)] font-bold leading-[0.95] tracking-tight">
          <span className="hero-shimmer">{site.name}</span>
        </h1>

        <p className="animate-rise-delay-2 mt-6 max-w-xl text-base leading-relaxed text-muted sm:text-lg">
          {site.tagline}
        </p>
